...
export function formDataToAppConfig(
  ...
  return {
    ...
    launchCommands: formData.launchCommands.trim(),
    ...
    portToCheck: formData.portToCheck
      ? parseInt(formData.portToCheck, 10)
      : undefined,
...
export function validateFormData(
  ...
  if (!formData.launchCommands.trim()) {
    errors.launchCommands = 'Launch commands are required'
  } else if (formData.launchCommands.trim().length > 2000) {
